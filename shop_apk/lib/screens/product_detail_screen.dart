...
import 'package:shop_apk/bloc/comment/comment_bloc.dart';
import 'package:shop_apk/bloc/comment/comment_event.dart';
                ...
                if (state is ProductResponseState) ...{
                  SliverToBoxAdapter(
                    child: GestureDetector(
                          ...
                          builder: (context) {
                            return BlocProvider(
                              create: (context) {
                                ...
                                bloc.add(
                                  CommentInitEvent(parentWidget.product.id),
                                );
                                return bloc;
                              },
                      ...
                      child: BlocProvider(
                        create: (context) {
                          var commentBloc = CommentBloc(locator.get());
                          commentBloc
                              .add(CommentInitEvent(parentWidget.product.id));
                          return commentBloc;
                        },
                        child: PictureWidget(),
                      ),
